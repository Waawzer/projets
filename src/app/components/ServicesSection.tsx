...
const services = [
  ...
  },
  {
    ...
    description: 'Des applications web complètes avec fonctionnalités avancées et expérience utilisateur fluide',
    icon: '💻',
    features: [
  ...
  },
  {
    id: 'e-commerce',
    title: 'E-Commerce',
    description: 'Solutions e-commerce personnalisées avec gestion de produits et paiements sécurisés',
    icon: '🛒',
    features: [
...
const ServicesSection = () => {
  ...
  const cardContainerOpacity = useTransform(scrollYProgress, [0.1, 0.3], [0, 1]);
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <motion.div 
                ...
                initial={{ opacity: 0 }}
                animate={{ 
                  opacity: hoveredService === service.id || selectedService === service.id ? 0.2 : 0,
              ...
              <motion.p 
                ...
                animate={{ opacity: selectedService === service.id ? 0.4 : 0.6 }}
              >
                {service.description}
              </motion.p>
              ...
              <motion.div
                ...
                animate={{ 
                  scaleX: hoveredService === service.id || selectedService === service.id ? 1 : 0,
                }}
                transition={{ duration: 0.3 }}
              />
