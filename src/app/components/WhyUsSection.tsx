...
const features = [
  {
    ...
    icon: "✨",
    description:
      "Des designs modernes et élégants inspirés des dernières tendances web.",
  },
  {
    title: "Installation Incluse",
    icon: "🚀",
    description:
      "Nous nous occupons de tout : domaine, hébergement et mise en ligne.",
  },
  {
    title: "Formation Complète",
    icon: "📚",
    description:
      "Apprenez à gérer votre site facilement grâce à notre formation personnalisée.",
  },
  {
    title: "Prix Fixe",
    icon: "💰",
  ...
  },
  {
    ...
    icon: "🛠️",
    description:
      "Une assistance technique disponible pour répondre à vos questions.",
  },
  {
    title: "Personnalisation",
    icon: "🎨",
    description:
      "Adaptez votre site à votre image de marque et à vos besoins spécifiques.",
  },
];
      ...
      >
        ...
        >
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Nous proposons une solution complète et abordable pour votre
            présence en ligne. Notre objectif est de vous offrir un site web
            professionnel sans les tracas techniques.
          </motion.p>
