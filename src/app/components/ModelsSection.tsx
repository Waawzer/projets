...
const models = [
  {
    ...
    description:
      "Site web professionnel pour studio d'enregistrement avec réservation en ligne et présentation des équipements.",
    features: [
  ...
  },
  {
    ...
    description:
      "Vitrine élégante pour studio de tatouage avec portfolio des artistes et prise de rendez-vous.",
    features: [
  ...
  },
  {
    ...
    description:
      "Boutique en ligne pour artisans avec présentation des produits et système de commande simplifié.",
    features: [
  ...
  },
  {
    ...
    title: "Boulangerie",
    description:
      "Site vitrine pour boulangerie avec présentation des produits et informations pratiques.",
    features: [
      "Catalogue de produits",
...
const ModelsSection = () => {
  ...
  const parallaxY0 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -200 * parallaxElements[0].speed]
  );
  const parallaxY1 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -200 * parallaxElements[1].speed]
  );
  const parallaxY2 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -200 * parallaxElements[2].speed]
  );
  const parallaxY3 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -200 * parallaxElements[3].speed]
  );
  const parallaxY4 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -200 * parallaxElements[4].speed]
  );
  const parallaxY5 = useTransform(
    scrollYProgress,
    [0, 1],
    [0, -200 * parallaxElements[5].speed]
  );

  // Collection of parallax values
  const parallaxYValues = [
    parallaxY0,
    parallaxY1,
    parallaxY2,
    parallaxY3,
      ...
      {parallaxElements.map((el, index) => (
        <motion.div
          ...
          style={{
            ...
            top: el.y,
            background:
              "radial-gradient(circle at center, rgba(100, 100, 255, 0.3) 0%, transparent 70%)",
            opacity: el.opacity,
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full lg:w-1/3 order-2 lg:order-1">
            ...
            >
              ...
              <h4 className="text-sm text-white/80 uppercase tracking-wider mb-3">
                Fonctionnalités
              </h4>
        ...
        >
          <p className="text-white/60 text-lg mb-6">
            Tous nos sites sont disponibles pour seulement{" "}
            <span className="text-white font-semibold">200€</span>, installation
